//
//  SBSDKUIScanMachineReadableZoneWorkflowStep.h
//  ScanbotSDK
//
//  Created by Sebastian Husche on 03.12.18.
...
/**
 * A 'SBSDKUIWorkflowStep' subclass specialized on recognizing machine readable zones (MRZ) on either high-res
